<div id="Sidebar" class="flex flex-col pt-5 gap-10 rounded-r-3xl" style="width: 400px; background-color: #B0D9B1;">
    <div>
        ...
        <a href="/home" class="flex gap-4 justify-start items-center px-4 py-2 hover:bg-gray-200 rounded-xl">
            ...
            <p class="font-medium text-white">Beranda</p>
        </a>
        <div id="Study" class="flex gap-4 justify-start items-center px-4 py-2 hover:bg-gray-200 rounded-xl">
            ...
            <p class="font-medium" style="color: #064420;">Mengajar</p>
        </div>
        <div id="Course" class="flex gap-4 justify-start items-center px-4 py-2 hover:bg-gray-200 rounded-xl">
            ...
            <p class="font-medium" style="color: #064420;">My Course</p>
        </div>
        ...
        <div id="Setting" class="flex gap-4 justify-start items-center px-4 py-2 hover:bg-gray-200 rounded-xl">
            ...
            <p class="font-medium" style="color: #064420;">Settings</p>
        </div>
    </div>
</div>